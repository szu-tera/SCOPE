...
def compute_score_gpqa(model_response, gt_answer, fast=False):
    model_answer = choice_answer_clean_gpqa(model_response)
...
def choice_answer_clean_gpqa(pred: str):
    ...
    # if pred is a Choice answer, return Choice answer
    return pred
...
def reward_func(
    ...
    try:
        ...
        #     res = compute_score_gpqa(solution_str, str(ground_truth))
        # else:
